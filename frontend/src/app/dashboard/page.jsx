  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // Sort applications by appliedDate in descending order for latest first
        appsData.sort((a, b) => {
        ...
        // Fetch notifications
        // const notifResponse = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/notifications`, {
        //   headers: { Authorization: `Bearer ${token}` }
        // })
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">{stats.acceptedCount}</div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">{stats.interviewCount}</div>
                        <div className="ml-2 flex items-baseline text-sm font-semibold text-yellow-600">
                          {stats.interviewPercentage}%
                        </div>
                      </dd>
                    </dl>
                  </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="flex items-baseline">
                        <div className="text-2xl font-semibold text-gray-900">{stats.offerCount}</div>
                        <div className="ml-2 flex items-baseline text-sm font-semibold text-purple-600">
                          {stats.offerPercentage}%
                        </div>
                      </dd>
                    </dl>
                  </div>
