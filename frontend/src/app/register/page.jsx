                ...
                >
                  ...
                  <div className="relative rounded-md shadow-sm">
                    ...
                    <select
                      ...
                      value={form.role}
                      onChange={handleChange}
                      className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-3 py-3 border-gray-300 rounded-md appearance-none transition duration-200 cursor-pointer"
                    >
                ...
                >
                  <div className="flex items-center h-5">
                    <input
                      ...
                      type="checkbox"
                      required
                      className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition duration-200 cursor-pointer"
                    />
                  </div>
