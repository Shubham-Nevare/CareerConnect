    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/jobs`, {
        ...
        body: JSON.stringify({
          ...
          salary: String(Number(form.salary) * 100000), // Convert LPA to INR
          company: company._id,
          type: form.type,
        ...
        <div className="lg:w-1/3 bg-white rounded-xl shadow-sm border border-gray-200 p-6 max-h-fit">
          ...
          <form onSubmit={handlePostJob}>
            ...
            <button
              type="submit"
              disabled={posting}
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-medium transition-colors disabled:opacity-70 flex items-center"
            >
