    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          {/* Login Card */}
          <div className="bg-white rounded-xl shadow-lg overflow-hidden lg:mt-6">
            <div className="p-8">
      ...
      <div className="hidden lg:flex w-1/2 items-start justify-center p-8 ">
        <div className="w-full max-w-2xl text-center">
          <div className=" px-4">
            <Link href="/" className="inline-block">
              <h1 className="text-4xl font-bold text-blue-600 pt-6">
                CareerConnect
              </h1>
            </Link>
